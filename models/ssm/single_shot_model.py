...
from .faster_rcnn_ssm import FasterRCNN
from .backbone_utils_adjusted import resnet_fpn_backbone

__all__ = [
    "maskrcnn_resnet_fpn", "MaskRCNNPredictor", "MaskRCNNHeads"
]
...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 # Alex
                 s2predictor=None, box_score_thresh_classifier=-0.01, box_nms_thresh_classifier=0.75, box_head_s2=None, box_predictor_s2=None):
        ...
        super(MaskRCNN, self).__init__(
            ...
            box_score_thresh, box_nms_thresh, detections_per_img,
            box_fg_iou_thresh, box_bg_iou_thresh,
            box_batch_size_per_image, box_positive_fraction,
            bbox_reg_weights,
            # Alex
            s2predictor, box_score_thresh_classifier, box_nms_thresh_classifier, box_head_s2, box_predictor_s2)
...
def maskrcnn_resnet_fpn(backbone_name, pretrained=False, progress=True,
    ...
    model = MaskRCNN(backbone, **kwargs)
    return model
